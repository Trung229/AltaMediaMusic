...
const tracks1 = [
  {
    id: 1,
    url: 'https://s3.ap-southeast-1.amazonaws.com/vcpmc/SMediaEncryptedS/637847354415275265/637847354437334766_audio_xencryptionx.mp4',
  },
  {
    id: 2,
    url: 'https://alta-s3.dev-altamedia.com/vcpmc/SMediaEncryptedS/637847208893505968/637847209923031982_audio_xencryptionx.mp4',
  },
];
...
export const Main = (props: any) => {
  ...
  const {handleChildDataSent} = MainLogic();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.body}>
        <View style={styles.musicInfo}>
          ...
          <View style={styles.containerText}>
            <CustomText
              text={formatMessage('common.totalDuration')}
              size="small"
            />
